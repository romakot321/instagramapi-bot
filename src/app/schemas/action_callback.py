...
class Action(Enum):
    ...
    tracking_new_subscribers = ButtonData(action="t_new_subrs", text="🧑‍💻 Посмотреть подписавшихся")
    tracking_new_unsubscribed = ButtonData(action="t_new_unsubd", text="⭐ Посмотреть отписавшихся")
    tracking_subscribtions = ButtonData(action="t_new_subns", text="🧑‍💻 Посмотреть подписки")
    tracking_unsubscribes = ButtonData(action="t_new_unsubes", text="⭐ Посмотреть отписки")
